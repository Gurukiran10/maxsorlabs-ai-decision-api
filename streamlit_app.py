...
# Theme (colors, font, dark/light base) is set in .streamlit/config.toml
# using Streamlit's official theming system, rather than overriding internal
# CSS selectors here. Light/Dark/System switching is available natively via
# the ⋮ menu -> Settings -> "Choose app theme, colors and fonts".
...
def new_decision_page():
    ...
    with st.form("ticket_form"):
        ...
        submitted = st.form_submit_button(
            "Get AI Decision", use_container_width=True, type="primary"
        )
